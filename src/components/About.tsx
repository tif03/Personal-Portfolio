    ...
    <section id="about" className="relative px-16 py-24 flex justify-center">
      ...
      >
        ...
        <div className="flex flex-col gap-6 text-gray-600 leading-relaxed">
          <p>
            I'm a Master's in Computer Science graduate from <strong className="text-blue-dark font-semibold">Cornell Tech</strong> in New York City, where I focused on the intersection of <strong className="text-blue-dark font-semibold">technology and business</strong>, exploring how emerging technology drives real-world impact across industries. Through the program's entrepreneurial culture, I gained hands-on experience thinking like a founder: from customer research and product strategy to building and shipping a startup from scratch through Cornell Tech's <a href="https://cosmo-sim.lovable.app/" target="_blank" className="text-blue-dark font-semibold underline hover:text-pink-mid transition-colors">Startup Studio</a>.
          </p>
          <p>
