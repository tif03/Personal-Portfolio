...
function Experience() {
  return (
    <section id="experience" className="py-24 px-8 max-w-3xl mx-auto">
      <h2 className="text-5xl font-bold mb-12" style={{fontFamily: 'DM Serif Display'}}>Experience</h2>
      <div className="flex flex-col gap-6">
        {experiences.map((exp: ExperienceEntry, index: number) => (
          <div key={index} className="bg-white border border-pink-light rounded-2xl p-6 shadow-sm">
            <div className="mb-4">
              <h3 className="text-lg font-semibold text-blue-dark">{exp.company}</h3>
