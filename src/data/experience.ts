...
export const experiences: Experience[] = [
    ...
    },
    {
        ...
        bullets : [
            ...
            'Held regular weekly office hours offering individualized assistance',
            'Collaborated with course staff in weekly meetings to review pain points, identify areas of improvement, and provide feedback',
        ]
    },
    {
        company: 'Boston University Department of Computer Science',
        ...
        location: 'Boston, MA',
        bullets: [
            'Authored homework, lab, and exam problems bi-weekly with full solutions in LaTeX and Python',
